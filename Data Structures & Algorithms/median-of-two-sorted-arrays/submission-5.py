...
#   * Once the valid partitions are identified:
#       If total length odd, median is smallest value in right part.
#       If total length even, median is avg of largest value in left part and smallest value in right part.
#   * The left partitions altogether have to have exactly total // 2 elements.
# Idea:
