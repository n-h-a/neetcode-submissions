...
#       If mid == timestamp, we found it.
#       If mid < timestamp, then we need to look further right.
#       If mid > timestamp, then we need to look further left.
#   Return "" if list is empty. Otherwise, return value at hi.
